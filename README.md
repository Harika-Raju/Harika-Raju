...
- **API Design** — actively building and integrating APIs, focusing on design principles, integration patterns, and real-world use cases
- **System Design** — building scalable, reliable, and efficient architectures; applying concepts through practical implementations
...
**ML/AI:** PyTorch · Scikit-learn · FAISS · Sentence Transformers · CrewAI · AutoGen · Google ADK · Claude API · NLP  
...
Built production-grade Agentic AI systems for ISRO's ground operations — designed for offline, mission-critical deployment.
...
- Robust to real-time variations: illumination changes, orientation shifts, and object size differences
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Harika%20Raju-blue?style=flat&logo=linkedin)](https://www.linkedin.com/in/harikaraju2005)
[![GitHub](https://img.shields.io/badge/GitHub-Harika--Raju-black?style=flat&logo=github)](https://github.com/Harika-Raju)
